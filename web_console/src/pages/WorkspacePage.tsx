      ...
      <div className="workspace-column workspace-column-left">
        ...
        <div style={{ display: 'flex', gap: '6px', marginBottom: '8px' }}>
          <input
            ...
            style={{ flex: 1, padding: '8px 12px', borderRadius: '8px', border: '1px solid rgba(129,140,248,0.2)', background: 'rgba(0,0,0,0.2)', color: 'white', fontSize: '0.85rem' }}
          />
          <button type="button" onClick={handleSearch} style={{ padding: '8px 12px', borderRadius: '8px', background: 'rgba(129,140,248,0.15)', border: '1px solid rgba(129,140,248,0.3)', color: '#a5b4fc', cursor: 'pointer', fontSize: '0.85rem' }}>🔍</button>
        </div>
